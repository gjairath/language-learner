  ...
  return (
      <ContainerBelow>
          <OptionsWrapper>
                ...
                <a class={styles.button} data-type="3" onClick={handleTab}>Odd One Out</a>
          </OptionsWrapper>
   ...
   <div className={styles.flash_content}>    
       ...
       <div style={{height: "25px"}}> </div>
        ...
        <div className={styles.question_title}>
            ...
            Question {idx + 1} of {length_questions} [Winnings: {score}$, Difficulty: {weight}]
          </div>
          <div className={styles.question}>
          What matches <i>{questionsObj.length != 0 && all_cards[questionsObj[idx][4]][0]}</i>?
          </div>
